...
var FirebaseAuthService = class _FirebaseAuthService {
  app;
  auth;
  googleProvider;
  constructor() {
  ...
  signInWithGoogle() {
    return __async(this, null, function* () {
      const credential = yield signInWithPopup(this.auth, this.googleProvider);
      const idToken = yield credential.user.getIdToken();
      return idToken;
    });
  }
  static \u0275fac = function FirebaseAuthService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _FirebaseAuthService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _FirebaseAuthService, factory: _FirebaseAuthService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(FirebaseAuthService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
function LoginComponent_div_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(2, "path", 14)(3, "line", 15)(4, "line", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
  }
...
function LoginComponent_div_13__svg_svg_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275namespaceSVG();
    \u0275\u0275elementStart(0, "svg", 25);
    \u0275\u0275element(1, "path", 26)(2, "path", 27)(3, "path", 28)(4, "path", 29);
    \u0275\u0275elementEnd();
  }
}
function LoginComponent_div_13_span_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 24);
  }
}
function LoginComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LoginComponent_div_13_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onGoogleSignIn("login"));
    });
    \u0275\u0275template(2, LoginComponent_div_13_span_2_Template, 1, 0, "span", 21)(3, LoginComponent_div_13__svg_svg_3_Template, 5, 0, "svg", 22);
    \u0275\u0275elementStart(4, "span");
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "button", 23);
    \u0275\u0275listener("click", function LoginComponent_div_13_Template_button_click_6_listener() {
      \u0275\u0275restoreView(_r2);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onGoogleSignIn("register"));
    });
    \u0275\u0275template(7, LoginComponent_div_13_span_7_Template, 1, 0, "span", 21);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.loading && ctx_r0.actionType === "login");
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", !ctx_r0.loading || ctx_r0.actionType !== "login");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.loading && ctx_r0.actionType === "login" ? "Conectando con Google..." : "Iniciar Sesi\xF3n con Google");
    \u0275\u0275advance();
    \u0275\u0275property("disabled", ctx_r0.loading);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r0.loading && ctx_r0.actionType === "register");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r0.loading && ctx_r0.actionType === "register" ? "Conectando con Google..." : "Solicitar Registro de Vendedor");
  }
}
function LoginComponent_ng_template_14_span_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 24);
  }
}
function LoginComponent_ng_template_14_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function LoginComponent_ng_template_14_Template_button_click_17_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onGoToDashboard());
    });
    \u0275\u0275text(18, " Ir al Dashboard ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(19, "button", 34);
    \u0275\u0275listener("click", function LoginComponent_ng_template_14_Template_button_click_19_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r0 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r0.onLogout());
    });
    \u0275\u0275template(20, LoginComponent_ng_template_14_span_20_Template, 1, 0, "span", 21);
  ...
  if (rf & 2) {
    ...
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate1(" ", (tmp_2_0 = ctx_r0.authService.currentUser()) == null ? null : tmp_2_0.name, "");
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1(" ", (tmp_3_0 = ctx_r0.authService.currentUser()) == null ? null : tmp_3_0.email, "");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate((tmp_4_0 = ctx_r0.authService.currentUser()) == null ? null : tmp_4_0.role);
    \u0275\u0275advance(4);
    \u0275\u0275property("disabled", ctx_r0.loading);
    \u0275\u0275advance();
...
var LoginComponent = class _LoginComponent {
  ...
  onGoogleSignIn(mode) {
    return __async(this, null, function* () {
      ...
      this.successMessage = "";
      try {
        const idToken = yield this.firebaseAuthService.signInWithGoogle();
        this.authService.googleLogin(idToken).subscribe({
          next: (res) => {
            this.loading = false;
            this.actionType = null;
            if (res.success) {
              this.successMessage = mode === "register" ? "Cuenta registrada correctamente. Redirigiendo..." : "Sesi\xF3n iniciada con \xE9xito";
              const returnUrl = this.route.snapshot.queryParams["returnUrl"] || "/dashboard";
              setTimeout(() => this.router.navigateByUrl(returnUrl), 800);
            } else {
              this.errorMessage = res.error || "Error en la autenticaci\xF3n";
            }
          },
          error: (err) => {
            this.loading = false;
        ...
        this.loading = false;
        this.actionType = null;
        this.errorMessage = err.message || "Se cancel\xF3 la ventana de autenticaci\xF3n de Google";
      }
    });
  }
  onGoToDashboard() {
  ...
  onLogout() {
    ...
    this.authService.logout().subscribe({
      next: () => {
        this.loading = false;
        this.successMessage = "Sesi\xF3n cerrada";
      }
    });
  }
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LoginComponent, selectors: [["app-login"]], decls: 16, vars: 4, consts: [["sessionInfo", ""], [1, "login-page"], [1, "neu-card", "login-card"], [1, "seminario-header"], [1, "seminario-logo-container"], ["src", "assets/logo-seminario-removebg-preview.png", "alt", "Logo Pe\xF1a Seminario 2026", 1, "pe\xF1a-logo-img"], [1, "pe\xF1a-title"], [1, "seminario-subtitle"], [1, "app-subtitle"], ["class", "alert alert-danger", 4, "ngIf"], ["class", "alert alert-success", 4, "ngIf"], ["class", "auth-buttons", 4, "ngIf", "ngIfElse"], [1, "alert", "alert-danger"], ["viewBox", "0 0 24 24", 1, "icon"], ["d", "m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3z"], ["x1", "12", "y1", "9", "x2", "12", "y2", "13"], ["x1", "12", "y1", "17", "x2", "12.01", "y2", "17"], [1, "alert", "alert-success"], ["points", "20 6 9 17 4 12"], [1, "auth-buttons"], [1, "neu-btn", "neu-btn-bordo", "btn-google", 3, "click", "disabled"], ["class", "neu-spinner", 4, "ngIf"], ["class", "google-icon", "viewBox", "0 0 24 24", 4, "ngIf"], [1, "neu-btn", "btn-google-secondary", 3, "click", "disabled"], [1, "neu-spinner"], ["viewBox", "0 0 24 24", 1, "google-icon"], ["fill", "#4285F4", "d", "M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"], ["fill", "#34A853", "d", "M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"], ["fill", "#FBBC05", "d", "M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z"], ["fill", "#EA4335", "d", "M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z"], [1, "session-details", "neu-card"], [1, "neu-badge", "neu-badge-vendido"], [1, "actions"], [1, "neu-btn", "neu-btn-bordo", 3, "click"], [1, "neu-btn", "btn-logout-action", 3, "click", "disabled"]], template: function LoginComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "section", 1)(1, "div", 2)(2, "div", 3)(3, "div", 4);
      \u0275\u0275element(4, "img", 5);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "h1", 6);
      \u0275\u0275text(6, "LA PE\xD1A DEL SEMINARIO 2026");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "p", 7);
      \u0275\u0275text(8, "Seminario Mayor de C\xF3rdoba");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "p", 8);
      \u0275\u0275text(10, "Sistema Oficial de Gesti\xF3n y Validaci\xF3n de Entradas");
      \u0275\u0275elementEnd()();
      \u0275\u0275template(11, LoginComponent_div_11_Template, 6, 1, "div", 9)(12, LoginComponent_div_12_Template, 4, 1, "div", 10)(13, LoginComponent_div_13_Template, 10, 7, "div", 11)(14, LoginComponent_ng_template_14_Template, 23, 5, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      const sessionInfo_r4 = \u0275\u0275reference(15);
      \u0275\u0275advance(11);
      \u0275\u0275property("ngIf", ctx.errorMessage);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.successMessage);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", !ctx.authService.isAuthenticated())("ngIfElse", sessionInfo_r4);
    }
  }, dependencies: [CommonModule, NgIf], styles: ['\n\n.login-page[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  min-height: calc(100vh - 160px);\n  padding: 2rem 1rem;\n}\n.login-card[_ngcontent-%COMP%] {\n  max-width: 480px;\n  width: 100%;\n  text-align: center;\n  padding: 2.5rem 2rem;\n  border-top: 4px solid var(--color-gold, #D4AF37);\n}\n.seminario-header[_ngcontent-%COMP%] {\n  margin-bottom: 2rem;\n}\n.seminario-logo-container[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  margin-bottom: 1rem;\n}\n.pe\\f1 a-logo-img[_ngcontent-%COMP%] {\n  width: 140px;\n  height: auto;\n  max-height: 140px;\n  object-fit: contain;\n  filter: drop-shadow(0 4px 12px rgba(122, 0, 30, 0.15));\n  transition: transform 0.3s ease;\n}\n.pe\\f1 a-logo-img[_ngcontent-%COMP%]:hover {\n  transform: scale(1.05);\n}\n.pe\\f1 a-title[_ngcontent-%COMP%] {\n  font-size: 1.6rem;\n  font-weight: 800;\n  color: var(--color-bordo, #7A001E);\n  margin-bottom: 0.25rem;\n}\n.seminario-subtitle[_ngcontent-%COMP%] {\n  font-family: var(--font-heading, "Cinzel", serif);\n  font-weight: 600;\n  color: var(--color-gold, #D4AF37);\n  font-size: 1rem;\n  margin-bottom: 0.5rem;\n}\n.app-subtitle[_ngcontent-%COMP%] {\n  font-size: 0.9rem;\n  color: var(--text-secondary, #665A5D);\n}\n.auth-buttons[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: 1rem;\n  margin-top: 1.5rem;\n}\n.btn-google[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 0.9rem 1.2rem;\n  font-size: 1rem;\n}\n.btn-google-secondary[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 0.8rem 1.2rem;\n  font-size: 0.95rem;\n  color: var(--color-bordo, #7A001E);\n}\n.google-icon[_ngcontent-%COMP%] {\n  width: 20px;\n  height: 20px;\n}\n.alert[_ngcontent-%COMP%] {\n  padding: 0.9rem 1.2rem;\n  border-radius: var(--radius-sm, 8px);\n  margin-bottom: 1rem;\n  font-size: 0.9rem;\n  font-weight: 600;\n}\n.alert-danger[_ngcontent-%COMP%] {\n  background: rgba(239, 68, 68, 0.12);\n  color: #b91c1c;\n  border: 1px solid rgba(239, 68, 68, 0.3);\n}\n.alert-success[_ngcontent-%COMP%] {\n  background: rgba(34, 197, 94, 0.12);\n  color: #15803d;\n  border: 1px solid rgba(34, 197, 94, 0.3);\n}\n.session-details[_ngcontent-%COMP%] {\n  text-align: left;\n  margin-top: 1.5rem;\n}\n.session-details[_ngcontent-%COMP%]   h3[_ngcontent-%COMP%] {\n  font-size: 1.2rem;\n  margin-bottom: 0.8rem;\n  color: var(--color-bordo, #7A001E);\n}\n.session-details[_ngcontent-%COMP%]   p[_ngcontent-%COMP%] {\n  font-size: 0.95rem;\n  margin-bottom: 0.5rem;\n  color: var(--text-primary, #2B2325);\n}\n.actions[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 0.75rem;\n  margin-top: 1.2rem;\n}\n.btn-logout-action[_ngcontent-%COMP%] {\n  background: rgba(239, 68, 68, 0.1);\n  color: #b91c1c;\n  border: 1px solid rgba(239, 68, 68, 0.3);\n}\n/*# sourceMappingURL=login.component.css.map */'] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(LoginComponent, [{
    type: Component,
    args: [{ selector: "app-login", standalone: true, imports: [CommonModule], template: `<section class="login-page">
  <div class="neu-card login-card">
    <div class="seminario-header">
      <div class="seminario-logo-container">
        <img src="assets/logo-seminario-removebg-preview.png" alt="Logo Pe\xF1a Seminario 2026" class="pe\xF1a-logo-img">
      </div>
      <h1 class="pe\xF1a-title">LA PE\xD1A DEL SEMINARIO 2026</h1>
      <p class="seminario-subtitle">Seminario Mayor de C\xF3rdoba</p>
      <p class="app-subtitle">Sistema Oficial de Gesti\xF3n y Validaci\xF3n de Entradas</p>
    </div>
    ...
    <div *ngIf="!authService.isAuthenticated(); else sessionInfo" class="auth-buttons">
      <button (click)="onGoogleSignIn('login')" [disabled]="loading" class="neu-btn neu-btn-bordo btn-google">
        <span *ngIf="loading && actionType === 'login'" class="neu-spinner"></span>
        <svg *ngIf="!loading || actionType !== 'login'" class="google-icon" viewBox="0 0 24 24">
          <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
          <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
          <path fill="#FBBC05" d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z"/>
          <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z"/>
        </svg>
        <span>{{ loading && actionType === 'login' ? 'Conectando con Google...' : 'Iniciar Sesi\xF3n con Google' }}</span>
      </button>

      <button (click)="onGoogleSignIn('register')" [disabled]="loading" class="neu-btn btn-google-secondary">
        <span *ngIf="loading && actionType === 'register'" class="neu-spinner"></span>
        <span>{{ loading && actionType === 'register' ? 'Conectando con Google...' : 'Solicitar Registro de Vendedor' }}</span>
      </button>
    </div>

    <ng-template #sessionInfo>
      <div class="session-details neu-card">
        <h3>Sesi\xF3n Activa</h3>
        <p><strong>Usuario:</strong> {{ authService.currentUser()?.name }}</p>
        <p><strong>Email:</strong> {{ authService.currentUser()?.email }}</p>
        <p><strong>Rol:</strong> <span class="neu-badge neu-badge-vendido">{{ authService.currentUser()?.role }}</span></p>

        <div class="actions">
          <button (click)="onGoToDashboard()" class="neu-btn neu-btn-bordo">
            Ir al Dashboard
          </button>
          <button (click)="onLogout()" [disabled]="loading" class="neu-btn btn-logout-action">
...
@firebase/auth/dist/esm/index-CvXU3_1x.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GJHQRE2W.js.map
