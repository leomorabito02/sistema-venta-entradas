...
# backend
sonar-scanner   -Dsonar.projectKey=sistema-ventas-entradas-backend   -Dsonar.sources=.   -Dsonar.host.url=http://localhost:9000   -Dsonar.token=sqp_73620ff9041443df7f2180229f5bdde8200ebefa